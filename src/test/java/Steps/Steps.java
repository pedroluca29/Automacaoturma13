...
public class Steps {
	...
	public void selecione_o_botao_abrir_nova_conta() throws Throwable {
		...
		m.click(e.getCookie(), "fechar cookie");
		m.pausa(5000, "pausa para fechar cookie");
	...
	public void o_usuario_preencher_o_formulario() throws Throwable {
	    ...
	    m.preencher(e.getCampoEmail(), "Teste01@gmail.com", "preenchendo campo Email");
	    m.preencher(e.getCampoCpf(), "796.406.230-16", "preenchendo campo cpf"  );
